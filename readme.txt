...
# > models/tropes.model & models/tropes.model.vectors.npy
python
>>> from gensim.models.word2vec import Word2Vec
>>> model = Word2Vec.load("./models/t2v-retrofit.model")
>>> model.wv.save("./models/tropes.model")
>>> from gensim.models.keyedvectors import KeyedVectors
>>> vectors = KeyedVectors.load("./models/tropes.model")
>>> print(vectors.most_similar("frog"))
...
# `md5sum ./models/tropes.model.vectors.npy` == `md5sum ./models/t2v-retrofit.model.wv.vectors.npy`
